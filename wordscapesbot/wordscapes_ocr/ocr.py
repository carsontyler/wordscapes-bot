...
def ocr_characters(image, volatile=True, max_attempts=3):
    attempts = 0
    while attempts < max_attempts:
        ...
        for c in cnts:
            ...
            if area > 375 or (area > 115 and i_test):
                ...
                # common copyright symbol that kept getting captured. Smoother transition when we only return here vs. continuing down below
                if character_string == '\u00A9':
                    return {}
